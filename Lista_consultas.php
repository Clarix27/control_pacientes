<?php
  ...
  if (empty($id_titular) && empty($id_beneficiario)) {
...
<head>
  ...
  <title>Consultas Beneficiario</title>
        ...
        <div class="tarjeta-consulta">
          ...
          <div class="contenido-tarjeta">
            ...
            <div class="boton-consulta">
              <a href="Recetas.php?consulta_id=<?= urlencode($c['pk_consulta'])?>&id_t=<?=urlencode($id_titular)?>&id_b=<?=urlencode($id_beneficiario)?>" class="btn-agregar">Agregar Receta</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
